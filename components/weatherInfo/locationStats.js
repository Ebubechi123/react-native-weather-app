...
import { Box, BoxContainer, DegreeSybmol, InnerDegreeCircle } from "../../screens/Home/HomeStyles"
import { Store } from "../../state management/context/contextStore";
import { Text } from "../Typography/typography"

const LocationStats = ()=>{
  const {theme,deviceWeather:{current}} = Store();
  ...
  let temp = current?.temp;
    return(
      <>
      <BoxContainer width={"100%"} justifyContent={'center'} alignItems={'center'} >
